        ...
        <div class="internship">
            <div class="internship-entry">
                ...
                <div class="internship-comments">
                    ...
                    <input type="text" class="inpFirst" id="lblFirst" placeholder="First Name" v-model="fName" required>

                     <label for="lblLast">Last Name</label>
                    <input type="text" class="inpLast" id="lblLast" placeholder="Last Name" v-model="lName" required>
    ...
    methods: {
        ...
        submitComment(internshipId)
        {
          let objComment = {
            ...
            // 1. create an object that will store properties and values.
            // the values will come from the data object (that has 2-way binding through v-model)
            /*
                example
           ...
           // 2. go to the store and dispatch an action call submitComment with the object you created
            ...
            this.lName='';
            this.inputEntry='';
           // 3. Reset the values on the form
